...
const psBotton = bottomContent.querySelectorAll('p')
psBotton[0].textContent = siteContent['main-content']['services-content']
psBotton[1].textContent = siteContent['main-content']['product-content']
psBotton[2].textContent = siteContent['main-content']['vision-content']
